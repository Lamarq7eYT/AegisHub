...
export class ExperimentLoader {
  ...
  async loadBuiltIn(id: 'repo.private.contents-read-boundary.v1' | 'repo.private.rest-graphql-authorization.v1' | 'repo.private.workflow-write-boundary.v1'): Promise<LoadedExperiment> {
